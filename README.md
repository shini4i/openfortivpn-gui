...
- **Secure Credential Storage** - Passwords stored in system keyring (libsecret); a password the gateway rejects is discarded so the next connection prompts for it again
